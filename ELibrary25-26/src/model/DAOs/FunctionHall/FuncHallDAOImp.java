...
public class FuncHallDAOImp {
    ...
    public List<DAOFuncHall> checkDayForEvent(String facilityCode) {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD); 
        		PreparedStatement stmt = conn.prepareStatement("SELECT * FROM HALL_RESERVATION WHERE FunctionHallCode = ?")) {
    ...
    public List<DAOFuncHall> checkDayForEvent() {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD); 
        		PreparedStatement stmt = conn.prepareStatement("SELECT * FROM HALL_RESERVATION")) {

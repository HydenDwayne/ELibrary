...
public class ReportsTeleconRoom extends JPanel {
    ...
    public ReportsTeleconRoom() {
        setLayout(new BorderLayout());

        // Column names
        String[] columnNames = {
            "Function Hall Code", "Hall Reservation Number", "Librarian ID",
            "Patron ID", "Event Name", "Date Of Event", "Start Time", "End Time"
        };

        // Dummy data rows with your hall codes
        ReportsController comp = new ReportsController("TelecomRoom");

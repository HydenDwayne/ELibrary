...
public class ArchivedPatron extends JPanel {
    ...
    public ArchivedPatron() {
        ...
        JLabel bodyTitle = new JLabel(
            "ALL ARCHIVED RECORDS OF PATRONS",
        ...
        unarchiveBtn.addActionListener(e -> {
        	...
        	if (selectedRow != -1) {
        	    ...
        	    ArchiveController ac = new ArchiveController("Patrons", firstColumnValue);

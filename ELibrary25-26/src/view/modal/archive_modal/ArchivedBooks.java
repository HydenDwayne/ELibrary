...
public class ArchivedBooks extends JPanel {
    ...
    public ArchivedBooks() {
        ...
        unarchiveBtn.addActionListener(e -> {
        	...
        	if (selectedRow != -1) {
        	    ...
        	    ArchiveController ac = new ArchiveController("Books", firstColumnValue);

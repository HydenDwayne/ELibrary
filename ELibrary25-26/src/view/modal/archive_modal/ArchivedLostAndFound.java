...
public class ArchivedLostAndFound extends JPanel {
    ...
    public ArchivedLostAndFound() {
        ...
        JLabel bodyTitle = new JLabel(
            "ARCHIVED RECORDS OF LOST AND FOUND",
        ...
        unarchiveBtn.addActionListener(e -> {
        	...
        	if (selectedRow != -1) {
        	    ...
        	    ArchiveController ac = new ArchiveController("LostAndFound", firstColumnValue);

...
4. Go to where the project is saved in the File Explorer (usually in \eclipse-workspace) -> open your project folder -> delete the bin folder
5. Right click \src in your project -> Properties -> select Java Build Path on the left panel -> select Source up on the ribbon -> click Browse on the bottom -> dropdown the project -> Create New Folder > name it "bin" -> Apply and Close
6. Select the project in the Package Explorer -> Project in the menu bar up top -> Clean -> select the project then clean
